...
exports.createUserSchema = zod_1.default.object({
    name: zod_1.default.string().trim().min(2, "Name must be at least 2 characters"),
    email: zod_1.default.string().email("Please enter a valid email").toLowerCase().trim(),

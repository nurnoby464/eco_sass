...
router.get("/", AuthenticateHelper_1.authenticate, saleAuthenticateAndUnauthenticate_1.saleAnAuthenticateAndUnauthenticated, AuthenticateHelper_1.verifySession, (0, validate_1.validate)({ query: staff_validation_1.customerQuerySchema }), StaffController.getCustomerList);
